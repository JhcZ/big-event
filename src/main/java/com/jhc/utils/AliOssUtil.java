...
public class AliOssUtil {
    ...
    private static final String ACCESS_ID = "LTAI5tSN3QodThJjJrT1b5GK";
    private static final String ACCESS_SECRET = "k4cUoGxpeKL8XGbbti3Xo28p08lq0w";
    // 填写Bucket名称，例如examplebucket。
    private static final String BUCKETNAME = "big-event-jhc";
